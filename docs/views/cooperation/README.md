...
6. 开发规范，大家根据项目需要随时补充；
7. 按照 **[Trello](https://trello.com/)** 的未进行的和进行中的计划来进行开发，如果决定开发某个卡片里的内容，请在群里说一下，避免重复开发；
8. 如果有新的需求或功能调整和重构，要在群里进行需求调研，开发者群有多数否决权，项目管理员有1/5的投票权。
:::
...
3. <span style="color: red">代码提交规范使用 `Angular 规范`，见 [详情](http://www.ruanyifeng.com/blog/2016/01/commit_message_change_log.html)
