...
![](http://qn.huat.xyz/content/20200926211129.png)

![](http://qn.huat.xyz/content/20200926211137.png)
...
![](http://qn.huat.xyz/content/20200926211215.png)
...
![](http://qn.huat.xyz/content/20200926211330.png)
...
- domain
  ...
  ：设置cookie的域。如果不设置，浏览器会自动将其设置为当前的请求域，比如，浏览器请求的地址是
...
- max-age
  ...
  ：设置cookie的相对有效期。expire和max-age通常仅设置一个即可。比如设置
